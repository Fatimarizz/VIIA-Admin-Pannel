...
const ReActivatingUserModal = ({ isOpen, onClose, data }) => {
                    ...
                    <div className="flex items-center justify-center">
                        <div className="bg-white max-w-lg rounded-lg p-5 overflow-y-scroll">
                            ...
                            <p className="text-center text-sm mt-2">
                                You are about to reactivate this user account
                                <span className="font-semibold"> ({data.fullName})</span>
                                <br />
                                click on <span className="font-semibold"> Cancel</span> to go back and  <span className="font-semibold"> Reactivate </span> to proceed.
                            </p>
                            </div>
...
export default ReActivatingUserModal;
