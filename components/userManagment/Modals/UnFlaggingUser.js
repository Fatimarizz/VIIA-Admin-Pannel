...
const UnFlaggingUserModal = ({ isOpen, onClose, data }) => {
            ...
            <Dialog open={isOpen} onClose={onClose} fullWidth maxWidth="xs" className="rounded-lg">
                <DialogTitle>
                    <div className="flex justify-between items-center">
                        <h3 className="text-lg font-semibold">UnFlagging User</h3>
                ...
                <div className="p-4">
                    ...
                    <div className="px-3 flex flex-col justify-center items-center my-4">
                        ...
                        <p className="text-center text-sm mt-2">
                            You are about to Unflag this user account
                            <span className="font-semibold"> ({data.FullName})</span>
                            <br />
                            click on <span className="font-semibold"> Cancel</span> to go back and  <span className="font-semibold"> UnFlag </span> to proceed.
                        </p>
                    </div>
                    <form onSubmit={formik.handleSubmit}>
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                rows="4"
                            ></textarea>
                            <p className="text-xs">e.g, inappropriate reception, spam, harassment , dangerous</p>
...
export default UnFlaggingUserModal;
