...
const DeletePaymentGateway = ({ isOpen, onClose , data }) => {
            ...
            <Dialog open={isOpen} onClose={onClose} fullWidth maxWidth="xs" className="rounded-lg">
                ...
                <div className="p-4">
                    ...
                    <div className="px-3 flex flex-col justify-center items-center my-4">
                        ...
                        You are about to delete this payment gateway with <span className="font-semibold mr-2 ">{data.PaymentMethod}</span> 
